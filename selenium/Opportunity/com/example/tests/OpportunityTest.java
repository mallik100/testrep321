...
String path= this.getClass().getProtectionDomain().getCodeSource().getLocation().toURI().getPath() + File.separator;
	...
	driver= recorderObj.Browser("autorabit.com-JVnvGK","OpportunityTest",path) ;
  ...
  public void testOpportunity() throws Exception {
    ...
    driver.findElement(By.xpath("//form[contains(@id,'form')]/input[2]")).click();
	    ...
	    driver.findElement(By.xpath("//div[@id='ep']/div[2]/div[3]/table/tbody/tr[2]/td[4]/div/span/input")).click();
	
	    driver.findElement(By.xpath("//div[@id='ep']/div[2]/div[3]/table/tbody/tr[2]/td[4]/div/span/input")).sendKeys("1/31/2018");
	    driver.findElement(By.xpath("//div[@id='ep']/div[2]/div[3]/table/tbody/tr[4]/td[4]/div/span/select")).click();
	
	    new Select(driver.findElement(By.xpath("//div[@id='ep']/div[2]/div[3]/table/tbody/tr[4]/td[4]/div/span/select"))).selectByVisibleText("Prospectingvcxvczx");recorderObj.waitSeconds(2);
